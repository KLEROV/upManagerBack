    ...
    <div class="app-container">
        ...
        <div class="head-container">
            ...
            <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
                ...
                <el-table-column prop="price" label="分成比">
                    <!-- <div>{{scope.row.divide?scope.row.divide*10:0}}%</div> -->
                </el-table-column>
                <el-table-column prop="price" label="扣量比">
                    <!-- <div>{{scope.row.costs?scope.row.costs*10:0}}%</div> -->
                </el-table-column>
